...
def artifact_update_7(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    filtered_artifact_0_data_filter_email_artifact_types = phantom.collect2(container=container, datapath=["filtered-data:filter_email_artifact_types:condition_1:artifact:*.id","filtered-data:filter_email_artifact_types:condition_1:artifact:*.cef.fileName","filtered-data:filter_email_artifact_types:condition_1:artifact:*.id","filtered-data:filter_email_artifact_types:condition_1:artifact:*.external_id"])
    ...
    for filtered_artifact_0_item_filter_email_artifact_types in filtered_artifact_0_data_filter_email_artifact_types:
        parameters.append({
            ...
            "name": filtered_artifact_0_item_filter_email_artifact_types[1],
            "label": None,
            "severity": None,
            "cef_field": None,
            "cef_value": None,
