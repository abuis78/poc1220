...
def set_summary_fields_1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    filtered_artifact_1_data_select_reported_email = phantom.collect2(container=container, datapath=["filtered-data:select_reported_email:condition_1:artifact:*.cef.bodyHtml","filtered-data:select_reported_email:condition_1:artifact:*.id","filtered-data:select_reported_email:condition_1:artifact:*.external_id"])
    ...
    for filtered_artifact_0_item_select_mc_incident in filtered_artifact_0_data_select_mc_incident:
        for filtered_artifact_1_item_select_reported_email in filtered_artifact_1_data_select_reported_email:
            if filtered_artifact_0_item_select_mc_incident[0] is not None:
                parameters.append({
                    "incident_id": filtered_artifact_0_item_select_mc_incident[0],
                    "pairs": [
                        { "name": "body_html", "value": filtered_artifact_1_item_select_reported_email[0] },
                    ],
                    "context": {'artifact_id': filtered_artifact_1_item_select_reported_email[1], 'artifact_external_id': filtered_artifact_1_item_select_reported_email[2]},
                })
